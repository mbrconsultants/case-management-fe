...
export const totalTransactions = {
  series: [{
    ...
    name: "Total Total Audited Vouchers",
    type: 'line',
...
export const Productsales=()=>{
  const columns=[
    ...
    },
    {
      ...
      cell:row=>
      // <h6 className="mb-0 fs-14 fw-semibold">{row.name}</h6>
      <span className="text-muted fs-15 fw-semibold">{row.date}</span>
    },
    {
      ...
      cell:row=>
      // <h6 className="mb-0 fs-14 fw-semibold">{row.name}</h6>
      <span className="text-muted fs-15 fw-semibold">{row.sno}</span>
    },
    {
      name: "AMOUNT",
    ...
    },
    {
      ...
      sortable: true,
      cell: row =><span className="" style={{display: 'flex', justifyContent: 'space-between'}}>
