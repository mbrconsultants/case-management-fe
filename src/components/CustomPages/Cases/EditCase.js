                ...
                <CRow>
                  <CCol md={4}>
                    <CFormLabel htmlFor="validationCustom02">
                      Suite Number <i style={{ color: "red" }}>*</i>
                    </CFormLabel>
                    <CFormInput
                  ...
                  <CCol md={4}>
                    <CFormLabel htmlFor="validationCustom02">
                      Hearing Date <i style={{ color: "red" }}>*</i>
                    </CFormLabel>
                    <CFormInput
                  ...
                  <CCol md={4}>
                    <CFormLabel htmlFor="validationCustomUsername">
                      Chamber Name <i style={{ color: "red" }}>*</i>
                    </CFormLabel>
                    <Form.Group>
                      <select
                        className="form-select"
                  ...
                  <CCol md={4}>
                    <CFormLabel htmlFor="validationCustom02">
                      Appellant Title <i style={{ color: "red" }}>*</i>
                    </CFormLabel>
                    <select
                      className="form-select"
                  ...
                  <CCol md={4}>
                    <CFormLabel htmlFor="validationCustomUsername">
                      Respondent Title <i style={{ color: "red" }}>*</i>
                    </CFormLabel>
                  ...
                  {/* {rows.map((row, index) => (
                    <div className="row" key={index}>
                      ...
                      <CCol md={3} className="mt-3">
                        <CFormLabel htmlFor={`removeRow${index}`}></CFormLabel>
                        {index > 0 && (
                          <button
                            type="button"
