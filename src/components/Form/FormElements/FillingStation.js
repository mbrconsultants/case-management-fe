  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">Renewal Of Filling station</h1>
      ...
      <Row>
        <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12">
          <Card>
            <Card.Header>
              <h4 className="card-title">Filling station</h4>
            </Card.Header>
            <Card.Body>
            <RegForm>
                <FormInput>
                    <label>Select a filling station</label>
                    <SelectBox>
                      <option>Total</option>
                      <option>NNPC</option>
                      <option>AA Rano</option>
                      <option>AFDIN</option>
                    </SelectBox>
                </FormInput>
                <FormInput>
                ...
                <FormInput>
                    <label>Filling Station Location</label>
                    <SelectBox>
                      <option>Jabi</option>
                      <option>Lugbe</option>
                      <option>Wuse</option>
                ...
                <FormInput>
                    ...
                    <InputBox type="number" placeholder="Enter Telephone number"/>
                </FormInput>
